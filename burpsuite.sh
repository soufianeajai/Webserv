...
<link rel="preload" href="/content/fonts/ps-main/ps-icons.woff?l1la2n" as="font" crossorigin="anonymous">
        <script nonce="LgyAwmBdZsIDWvGRlGaBg3jziKykq2yX">
...
<script nonce="LgyAwmBdZsIDWvGRlGaBg3jziKykq2yX">
    ...
    document.write('<nonce-script src="https://ps.containers.piwik.pro/'+id+'.sync.js' + qPString + '" nonce="LgyAwmBdZsIDWvGRlGaBg3jziKykq2yX"></' + 'nonce-script>');
...
(function(window, document, dataLayerName, id) {
    ...
    var isStgDebug=(window.location.href.match("stg_debug")||document.cookie.match("stg_debug"))&&!window.location.href.match("stg_disable_debug");
    stgCreateCookie("stg_debug",isStgDebug?1:"",isStgDebug?14:-1);
    var qP=[];dataLayerName!=="dataLayer"&&qP.push("data_layer_name="+dataLayerName),tags.nonce="LgyAwmBdZsIDWvGRlGaBg3jziKykq2yX",isStgDebug&&qP.push("stg_debug");
    var qPString=qP.length>0?("?"+qP.join("&")):"";
...
<div no-keyword-injection class="wrapper">
    ...
    <script src="/bundles/public/staticcms.js?v=MHEU4aZloOOy-yd7bhY-YQ828l4" nonce="LgyAwmBdZsIDWvGRlGaBg3jziKykq2yX"></script>
    ...
    <footer class="wrapper">
        <div class="container">
            ...
            <div>
                ...
                <p class="grey">&copy; 2024 PortSwigger Ltd.</p>
            </div>
        </div>
    </footer>
